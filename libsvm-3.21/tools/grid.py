...
class GridOption:
	def __init__(self, dataset_pathname, options):
		...
		if sys.platform != 'win32':
			...
			self.gnuplot_pathname = 'C:/Users/john/Desktop/spider/NewsClassifiction/gnuplot/bin/gnuplot'
		else:
			# example for windows
			...
			self.gnuplot_pathname = r'C:/Users/john/Desktop/spider/NewsClassifiction/gnuplot/bin/gnuplot.exe'
		self.fold = 5
